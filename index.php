...
/*=====================================================================
   Library
=====================================================================*/
FromKernel::uses('display/layout.lib','display/breadcrumbs.lib','course_user.lib');
...
ClaroBreadCrumbs::getInstance()->setCurrent( 
                    get_lang('General Report'), 
                    Url::Contextualize(
                        get_module_url($tlabelReq) . '/index.php?cidReset=true&cidReq='.claro_get_current_course_id()
                    ) 
                );
